...
原生优化、Inductor、prefix/denoise CUDA Graph、Triton attention；预热 1,600 条。开启低内存加载。需使用包含 PI0.5 原生优化的独立源码运行时，见上级 README。

延迟 ms，吞吐 obs/s，内存为峰值 CUDA allocated GiB。

| 数据集 | 观测数 | E2E | Forward | 吞吐 | 内存 |
|---|---:|---:|---:|---:|---:|
| LIBERO-10 | 1,600 | 313.34 | 303.33 | 3.191 | 10.79 |
