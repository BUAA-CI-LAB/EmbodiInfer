...
def main() -> None:
    ...
    url = "https://raw.githubusercontent.com/robbyant/lingbot-vla/4eb34b7693a0565c67433f8fac9c59a2e67eb60b/assets/norm_stats/robotwin_50.json"
    with urllib.request.urlopen(url, timeout=30) as response:
        data = response.read()
    if hashlib.sha256(data).hexdigest() != "7a14326dee344f30635afa11ff50003dfea665bfded3720dfeb1a025c5d28b1c":
        raise ValueError("published normalization file checksum mismatch")
    Path(config["norm_stats"]).write_bytes(data)
